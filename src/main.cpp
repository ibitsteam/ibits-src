...
const string strMessageMagic = "iBITS Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "iBITS", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Lawrence of Arabia star dies";
        CTransaction txNew;
        txNew.nTime = 1436617093;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1436617093;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 923020 : 0;



        //// Debug print
        assert(block.hashMerkleRoot == uint256("0x5b002a8c6cc39df7a8f23a8d91d5a673420cdf0fa6065ecf26cd3097b4136fcb"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x06, 0xa2, 0x12, 0xb2 };
